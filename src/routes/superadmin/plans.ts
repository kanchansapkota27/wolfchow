...
const PLAN_COLUMNS =
  'id, name, device_cap, item_cap, category_cap, modifier_cap, smtp_monthly_limit, transaction_history_days, feature_flags, payment_methods_allowed, commission_type, commission_value, is_public, created_at'

  ...
  return (
    <div>
      ...
      <Link
        ...
        className="mb-5 flex items-center gap-4 rounded-2xl border border-blue-100 bg-blue-50 px-5 py-4 transition-colors hover:border-blue-200 hover:bg-blue-100"
      >

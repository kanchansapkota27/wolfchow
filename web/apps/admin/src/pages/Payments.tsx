    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-600">
          Use a <strong>restricted key</strong> instead of your full secret key. If a restricted key is ever
          leaked, an attacker can only interact with your existing payments — they cannot access your
          Stripe balance, trigger payouts, or touch account settings.
        </p>
        ...
        <button
          onClick={onClose}
          className="w-full text-sm bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg px-4 py-2"
        >
          Got it
        </button>
      </div>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <button
              ...
              className="w-4 h-4 rounded-full bg-gray-200 hover:bg-indigo-100 hover:text-indigo-700 text-gray-500 text-xs font-bold flex items-center justify-center leading-none transition-colors"

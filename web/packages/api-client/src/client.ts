...
export function createApiClient(config: ApiClientConfig) {
  ...
  const admin = {
    ...
    patchRestaurant: (data: Partial<Pick<Restaurant, 'display_name' | 'business_name' | 'address' | 'cuisine_type' | 'services_offered' | 'logo_r2_key' | 'menu_image_display' | 'special_requests_enabled'>>) =>
